...
//            e.printStackTrace();
//        }
//        com.epic.localmusicnoserver.BlueTooth.BlueToothDataManager.getInstance().init(4);
...
//                            com.epic.localmusicnoserver.BlueTooth.BlueToothDataManager.getInstance().processString(content);
//                        }
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                        break;
